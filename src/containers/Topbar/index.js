  ...
  return (
    <Header>
      ...
      <Link to="/" className="gx-d-block gx-d-lg-none gx-pointer">
        <img height="40" alt="" src={require("assets/images/cs-loginPageLogo.png")}/>
      </Link>
...
/* {width < TAB_SIZE ? null : 
        <div>
          <img height="55" alt="" src={require("assets/images/cs-icon.png")}/>
          <img height="45" alt="" src={require("assets/images/cs-logo6.png")}/>
        </div>
      }
