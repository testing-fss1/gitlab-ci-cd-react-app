    ...
    <div className="gx-layout-sider-header">
      ...
      <Link to="/" className="gx-site-logo">
        {navStyle === NAV_STYLE_NO_HEADER_MINI_SIDEBAR && width >= TAB_SIZE ?
          <img height="60" alt="" src={require("assets/images/cs-loginPageIcon.png")}/> :
          themeType === THEME_TYPE_LITE ?
            <img alt="" src={require("assets/images/cs-loginPageIcon.png")}/> :

            <div>
              <img height="60" alt="" src={require("assets/images/cs-loginPageIconLight.png")}/>
              <img alt="" src={require("assets/images/cs-loginPageLogoLight.png")}/>
            </div>
          }
