...
test('Alpha onChange events correctly', function () {
  ...
  var tree = mount(React.createElement(Alpha, _extends({}, red, { width: 20, height: 200, onChange: changeSpy })));
...
test('Alpha renders vertically', function () {
  var tree = renderer.create(React.createElement(Alpha, _extends({}, red, { width: 20, height: 200, direction: 'vertical' }))).toJSON();
  expect(tree).toMatchSnapshot();
});
