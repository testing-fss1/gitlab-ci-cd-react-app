...
test('Chrome renders correctly', function () {
  var tree = renderer.create(React.createElement(Chrome, red)).toJSON();
...
test('Chrome onChange events correctly', function () {
  ...
  var tree = mount(React.createElement(Chrome, _extends({}, red, { onChange: changeSpy })));
...
test('ChromeFields renders correctly', function () {
  var tree = renderer.create(React.createElement(ChromeFields, red)).toJSON();
  expect(tree).toMatchSnapshot();
});
