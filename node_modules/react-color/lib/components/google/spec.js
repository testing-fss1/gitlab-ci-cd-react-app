...
test('Google renders correctly', function () {
  var tree = _reactTestRenderer2.default.create(_react2.default.createElement(_Google2.default, _color.red)).toJSON();
...
test('Google onChange events correctly', function () {
  ...
  var tree = (0, _enzyme.mount)(_react2.default.createElement(_Google2.default, _extends({}, _color.red, { onChange: changeSpy })));
  expect(changeSpy).toHaveBeenCalledTimes(0);
});

test('GoogleFields renders correctly', function () {
  var tree = _reactTestRenderer2.default.create(_react2.default.createElement(_GoogleFields2.default, _color.red)).toJSON();
  expect(tree).toMatchSnapshot();
});
