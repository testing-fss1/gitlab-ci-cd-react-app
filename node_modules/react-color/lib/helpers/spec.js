...
describe('helpers/color', function () {
  ...
  describe('isValidHex', function () {
    ...
    test('allow transparent color', function () {
      expect(_color2.default.isValidHex('transparent')).toBeTruthy();
    });
...
describe('validColorString', function () {
  test('checks for valid RGB string', function () {
    expect(_color2.default.isvalidColorString('23, 32, 3', 'rgb')).toBeTruthy();
    expect(_color2.default.isvalidColorString('290, 302, 3', 'rgb')).toBeTruthy();
    expect(_color2.default.isvalidColorString('23', 'rgb')).toBeFalsy();
    expect(_color2.default.isvalidColorString('230, 32', 'rgb')).toBeFalsy();
  });

  test('checks for valid HSL string', function () {
    expect(_color2.default.isvalidColorString('200, 12, 93', 'hsl')).toBeTruthy();
    expect(_color2.default.isvalidColorString('200, 12%, 93%', 'hsl')).toBeTruthy();
    expect(_color2.default.isvalidColorString('200, 120, 93%', 'hsl')).toBeTruthy();
    expect(_color2.default.isvalidColorString('335°, 64%, 99%', 'hsl')).toBeTruthy();
    expect(_color2.default.isvalidColorString('100', 'hsl')).toBeFalsy();
    expect(_color2.default.isvalidColorString('20, 32', 'hsl')).toBeFalsy();
  });

  test('checks for valid HSV string', function () {
    expect(_color2.default.isvalidColorString('200, 12, 93', 'hsv')).toBeTruthy();
    expect(_color2.default.isvalidColorString('200, 120, 93%', 'hsv')).toBeTruthy();
    expect(_color2.default.isvalidColorString('200°, 6%, 100%', 'hsv')).toBeTruthy();
    expect(_color2.default.isvalidColorString('1', 'hsv')).toBeFalsy();
    expect(_color2.default.isvalidColorString('20, 32', 'hsv')).toBeFalsy();
    expect(_color2.default.isvalidColorString('200°, ee3, 100%', 'hsv')).toBeFalsy();
  });
});